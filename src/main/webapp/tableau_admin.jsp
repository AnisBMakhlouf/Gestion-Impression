...
<head>
  ...
  <link href="assetsDashboard/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="assetsDashboard/css/argon-dashboard.css?v=2.0.3" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Gestion Impression</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link " href="${pageContext.request.contextPath}/listeEnseignant.jsp">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Table enseignant</span>
          </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href=""${pageContext.request.contextPath}/listeEnseignants_Admin.jsp">
              ...
              <span class="nav-link-text ms-1">Table agent de tirage</span>
            </a>
          </li>
          <li class="nav-item">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Gestion Classes</h6>
          ...
          <li class="nav-item">
            <a class="nav-link " href="pages/tables.html">
              ...
              <span class="nav-link-text ms-1">Table groups</span>
            </a>
          </li>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="${pageContext.request.contextPath}/listDemandeTirage_Admin.jsp">
            ...
            <span class="nav-link-text ms-1">Table demandes de tirage</span>
          </a>
        </li>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Admin-Dashboard</h5>
  ...
  <script src="assetsDashboard/js/argon-dashboard.min.js?v=2.0.3"></script>
</body>
