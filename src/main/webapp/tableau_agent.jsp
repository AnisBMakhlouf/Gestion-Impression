    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          ...
          <li class="nav-item">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Gestion tirage</h6>
            <a class="nav-link " href="pages/tables.html">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
              </div>
              <span class="nav-link-text ms-1">Table demandes de jour</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="pages/tables.html">
              ...
              <span class="nav-link-text ms-1">Table demande en cours</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="pages/tables.html">
              ...
              <span class="nav-link-text ms-1">Table archive</span>
            </a>
          </li>
